import { useNavigate, Form, redirect, type ActionFunctionArgs, useFetcher } from "react-router-dom"
            ...
            <td className="p-3 text-lg text-gray-800">
                <fetcher.Form method="POST">
                    <button
                        ...
                        name="id"
                        value={product.id}
                        className={`${isAvailable ? 'text-black' : 'text-red-600'} rounded-lg p-2 text-xs uppercase font-bold w-full hover:cursor-pointer border border-black/50 `}
                    >
